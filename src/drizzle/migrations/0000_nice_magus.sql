...
ALTER TABLE "course_products" ADD CONSTRAINT "course_products_productId_courses_id_fk" FOREIGN KEY ("productId") REFERENCES "public"."courses"("id") ON DELETE cascade ON UPDATE no action;